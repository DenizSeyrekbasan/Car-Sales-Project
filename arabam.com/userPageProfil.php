...
<head>
    ...
    <title><?php echo $_SESSION['user_name']?> Profil Sayfası</title>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Merhaba <b><?php echo $_SESSION['user_name']?></b>-Profil Düzenle</h1>
                    </div>

                    <?php 
                    
                    $bilgi=$db->prepare("SELECT * FROM uye_bilgileri WHERE uye_adi=:adi");
                    $bilgi->execute([
                    'adi'=>$_GET['uye_adi']
                    ]);
...
<div>
    <form action="islemler.php" method="POST">
        <div >
        <ul>
            <input type="hidden" name="uye_id" value="<?php echo $bilgi_cek['uye_id'] ?>"/>
        </ul>
        <ul>
            <input type="text" name="uye_adi"value="<?php echo $bilgi_cek['uye_adi'] ?>"/>
        </ul>
        <ul>
            <input type="text" name="uye_soyadi" value="<?php echo $bilgi_cek['uye_soyadi'] ?>"/>
        </ul>
        <ul>
            <input type="text" name="uye_telefon"value="<?php echo $bilgi_cek['uye_telefon'] ?>"/>
        </ul>
        <ul>
            <input type="text" name="uye_email"value="<?php echo $bilgi_cek['uye_email'] ?>"/>
        </ul>
        <ul>
            <input type="text" name="uye_tc"value="<?php echo $bilgi_cek['uye_tc'] ?>"/>
        </ul>
        <ul>
            <input type="text" name="uye_adres"value="<?php echo $bilgi_cek['uye_adres'] ?>" />
        </ul>
        <ul>
            <input type="text" name="uye_sifre"value="<?php echo $bilgi_cek['uye_sifre'] ?>" />
        </ul>   
        <ul>
            <input type="submit" class="btn btn-primary" name="uyeUpdateIslemi"  value="Bilgilerimi Kaydet">
        </ul>  
        </div>
    </form>
</div>
