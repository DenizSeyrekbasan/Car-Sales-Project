            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="#">İlanlarımı Görüntüle</a>
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="section-heading">
              ...
              <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800"><b>İlanlarım</b></h1>
                    </div>
            </div>
          </div>
          
          <?php 
          $arac=$db->prepare("SELECT * FROM ilan_bilgileri WHERE satici_isim=:isim");
          $arac->execute([
          ...
          {?>
            ...
            <div class="product-item">
              <a href="userPageDuzenle.php?ilan_id=<?php echo $arac_bilgi_cek["ilan_id"] ?>"><img width="300" height="200" src="resim/<?php echo $arac_bilgi_cek["arac_resim_ad"] ?>" alt=""></a>
